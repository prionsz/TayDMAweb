...
if ( ! class_exists( 'CodelessCustomSidebars' ) ) {
	...
	class CodelessCustomSidebars {
		...
		public static function scripts( $hook ){
			...
			wp_enqueue_style( 'codeless-custom-sidebars-panel', get_template_directory_uri() . '/includes/codeless_theme_panel/assets/css/codeless-custom-sidebars.css' );
			wp_enqueue_script( 'codeless-custom-sidebars-panel', get_template_directory_uri() . '/includes/codeless_theme_panel/assets/js/codeless-custom-sidebars.js', array( 'cl-select2' ) );
		}
		...
		public static function addPage() {
			if( function_exists( 'codeless_add_submenu_page' ) )
				codeless_add_submenu_page(
					'codeless-panel',
					esc_html__( 'Custom Sidebars', 'remake' ),
					esc_html__( 'Custom Sidebars', 'remake' ),
					'administrator',
		...
		public static function createPage() {
			...
			<div class="wrap">
				...
				<h2><?php esc_html_e( 'Custom Sidebars', 'remake' ); ?></h2>

				<p><?php esc_html_e( 'In this Options Section you can define Custom Sidebars for pages, categories or a completely custom sidebar to be used on page builder (header or content).', 'remake' ); ?></p>
				...
				<form method="post" action="options.php">
					...
					<table class="form-table">
							...
							<tr valign="top">
								...
								<td>
									<label><?php esc_html_e('Custom Sidebar for pages:', 'remake') ?></label>
							...
							<tr valign="top">
								...
								<td>
									<label><?php esc_html_e('Custom Sidebar for categories:', 'remake') ?></label>
