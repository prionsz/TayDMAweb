...
class CodelessAdsWidget extends WP_Widget{
    ...
    function __construct(){
        ...
        $options = array('classname' => 'widget_ads', 'description' => esc_html__( 'Add an ad', 'remake' ), 'customize_selective_refresh' => true );
    ...
    function widget($atts, $instance){
        ...
        echo '<a href="'.esc_url($ad_url).'"><img style="'.$extra_style.'" src="'.esc_url($ad_img).'" alt="'.esc_attr__('Banner Image', 'remake').'" /></a>';
