            ...
            <div class="inner-content <?php echo esc_attr( codeless_extra_classes( 'inner_content' ) ) ?>">
                ...
                <div class="inner-content-row <?php echo esc_attr( codeless_extra_classes( 'inner_content_row' ) ) ?>">
                    ...
                    <div class="content-col <?php echo esc_attr( codeless_extra_classes( 'content_col' ) ) ?>">
                        ...
                        <h1 class="page-title"><?php esc_attr_e( 'Oops! That page can&rsquo;t be found.', 'remake' ); ?></h1>

                        <p><?php echo esc_html( codeless_get_mod( '404_error_message', esc_html__( 'It looks like nothing was found at this location. Maybe try a search?', 'remake' ) ) ) ?></p>
                        ...
                        <div class="search__related">
                                ...
                                <div class="search__col">
                                    <h3><?php esc_attr_e('May We Suggest?', 'remake' ) ?></h3>
